export class CompteRendue {

        num_compte_rendu: number;
        user_ecrit: string;
        date_ecrit: number;
        ecrit: number;
        id_document: string;
        ...
        date_livre: null;
        user_livre: null;
        dicte_encours: number;
        dicte_termine: number;
        code_patient: string;
        code_admission: null;
        rdv: {
            num_Rdv: number;
            ...
            demande_examen: {
                ...
                admission: {
                    ...
                    adresse: string;
                    code_cabinet: null;
                    code_reservation_opd: null;
                    num_seq: null;
                    num_soc: number;
                    code_price_list: number;
                    code_lit: string;
                    code_etat_patient_opd: null;
                    code_service: number;
                    code_type_arrivee: number;
                    code_medecin_correspondant: null;
                    code_motif: number;
                    ...
                    code_lien_parente: null;
                    code_planning_cabinet: null;
                    date_arrivee: number;
            ...
            sortie_Salle_Manuelle: null;
            user_Entree_Salle: null;
            etat_attente_finale: number;
            code_Technicien: null;
            entree_Salle_Manuelle: null;
            user_validation: null;
            user_Sortie_Salle: null;
            date_validation: null;
